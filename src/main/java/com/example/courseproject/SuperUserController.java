...
public class SuperUserController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        inform.setOnAction(actionEvent -> {
            ...
            fxmloader.setLocation(getClass().getResource("/com/example/courseproject/SuperUserMyData.fxml"));
    ...
    private void getSelected (MouseEvent event){
        ...
        date.setText(quote_date.getCellData(index));
    ...
    public void Delete(){
        connection = ConnectionDataBase.Connect();
        String sql = "DELETE FROM " + Table.table_qoute + " WHERE " + Table.table_qoute_id + " = ? ";
        try {
    ...
    public void Insert (){
        ...
        String record = "INSERT INTO "+ Table.table_qoute + " (" + Table.table_qoute_quote + "," + Table.table_quote_teacher +
                "," + Table.table_quote_subject + "," + Table.table_quote_data + "," + Table.table_quote_id_user +
                ")VALUES(?,?,?,?,"+ + user.getId() + ")";
        try {
            pS = connection.prepareStatement(record);
